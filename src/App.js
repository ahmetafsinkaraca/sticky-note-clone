	...
	return (
		<MainContext.Provider value={data}>
			<div ref={screen} tabIndex={0} onClick={handleClick} onMouseMove={handleMouseMove} onKeyUp={handleKeyUp}
				...
				<img style={{opacity: '.7'}} src="https://paloalbums.com/cdn/shop/products/BK_grande.jpg?v=1643825909"/>
        ...
        <button  onClick={() => { clearNotes(); setMode(!mode); }}  className={mode ? 'active' : ''}>Notları Temizle</button>
			</div>
